...
.DESCRIPTION
    ...
    Bicep templates (subscription-scope wrappers → resource-group-scope modules):
      - infrastructure/bicep/control-plane/main.bicep  → modules/controlPlaneResources.bicep
      - infrastructure/bicep/session-hosts/main.bicep  → modules/sessionHostResources.bicep
...
$controlPlaneTemplate = Join-Path $repoRoot "infrastructure\bicep\control-plane\main.bicep"
$sessionHostTemplate  = Join-Path $repoRoot "infrastructure\bicep\session-hosts\main.bicep"
